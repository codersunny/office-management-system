...
<section class="content">
	 ...
	 <form method="post" action="{{ route('update.student.registration',$editData->id) }}" enctype="multipart/form-data">
	 	@csrf
...
<div class="col-md-4">
 ...
 <option value="{{ $year->name }}" {{ ($editData->year_id == $year->name)? "selected":"" }}  >{{ $year->name }}</option>
		 	@endforeach
...
<div class="col-md-4">
	 ...
	 <select name="group_id"   required="" class="form-control">
			...
			<option value="{{ $group->name }}" {{ ($editData->group_id == $group->name)? "selected":"" }} >{{ $group->name }}</option>
		 	@endforeach
...
<div class="col-md-4">
	 ...
	 <select name="shift_id"  required="" class="form-control">
			...
			<option value="{{ $shift->name }}" {{ ($editData->shift_id == $shift->name)? "selected":"" }} >{{ $shift->name }}</option>
		 	@endforeach
...
<div class="col-md-4">
 		...
 		<div class="form-group">
		<div class="controls">
	<img id="showImage" src="{{ (!empty($editData->image))? url('upload/student_images/'.$editData->image):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;"> 
